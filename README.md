...
* Debugging:
    ...
    * **34-debug-with-xdebug**: Please check the [README](https://github.com/swoole/docker-swoole/tree/master/examples/34-debug-with-xdebug) file included to see how to debug your PHP code in different ways with [Xdebug](https://xdebug.org). Xdebug works with Swoole on PHP 8.1+.

...
| PHP Versions | Default Images | Dev Images | ZTS Images | Alpine Images |
|-|-|-|-|-|
| PHP 8.5 | [6.2.3-php8.5][6.2-php8.5]<br />[6.2-php8.5] | [6.2.3-php8.5-dev][6.2-php8.5]<br />[6.2-php8.5-dev][6.2-php8.5] | [6.2.3-php8.5-zts][6.2-php8.5-zts]<br />[6.2-php8.5-zts] | [6.2.3-php8.5-alpine][6.2-php8.5-alpine]<br />[6.2-php8.5-alpine] |
| PHP 8.4 | [6.2.3-php8.4][6.2-php8.4]<br />[6.2-php8.4]<br />[6.2][6.2-php8.4]<br />[latest][6.2-php8.4] | [6.2.3-php8.4-dev][6.2-php8.4]<br />[6.2-php8.4-dev][6.2-php8.4]<br />[6.2-dev][6.2-php8.4]<br />[latest-dev][6.2-php8.4] | [6.2.3-php8.4-zts][6.2-php8.4-zts]<br />[6.2-php8.4-zts]<br />[6.2-zts][6.2-php8.4-zts]<br />[latest-zts][6.2-php8.4-zts] | [6.2.3-php8.4-alpine][6.2-php8.4-alpine]<br />[6.2-php8.4-alpine]<br />[6.2-alpine][6.2-php8.4-alpine]<br />[latest-alpine][6.2-php8.4-alpine] |
| PHP 8.3 | [6.2.3-php8.3][6.2-php8.3]<br />[6.2-php8.3] | [6.2.3-php8.3-dev][6.2-php8.3]<br />[6.2-php8.3-dev][6.2-php8.3] | [6.2.3-php8.3-zts][6.2-php8.3-zts]<br />[6.2-php8.3-zts] | [6.2.3-php8.3-alpine][6.2-php8.3-alpine]<br />[6.2-php8.3-alpine] |
| PHP 8.2 | [6.2.3-php8.2][6.2-php8.2]<br />[6.2-php8.2] | [6.2.3-php8.2-dev][6.2-php8.2]<br />[6.2-php8.2-dev][6.2-php8.2] | [6.2.3-php8.2-zts][6.2-php8.2-zts]<br />[6.2-php8.2-zts] | [6.2.3-php8.2-alpine][6.2-php8.2-alpine]<br />[6.2-php8.2-alpine] |
...
[6.2-php8.4]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.4/cli/Dockerfile
[6.2-php8.4-zts]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.4/zts/Dockerfile
[6.2-php8.4-alpine]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.4/alpine/Dockerfile
[6.2-php8.3]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.3/cli/Dockerfile
[6.2-php8.3-zts]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.3/zts/Dockerfile
[6.2-php8.3-alpine]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.3/alpine/Dockerfile
[6.2-php8.2]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.2/cli/Dockerfile
[6.2-php8.2-zts]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.2/zts/Dockerfile
[6.2-php8.2-alpine]: https://github.com/swoole/docker-swoole/blob/6.2.3/dockerfiles/6.2.3/php8.2/alpine/Dockerfile

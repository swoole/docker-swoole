...
* `phpswoole/swoole:4.8.8-php8.0-dev`
...
* `phpswoole/swoole:4.8.8-php8.0-alpine`
...
Note: We don't have development tools built in for Alpine images. There is no Docker images like `phpswoole/swoole:4.8.8-php8.1-alpine-dev`.
...
|-|-|-|-|
| PHP 8.1 | [4.8.8-php8.1, 4.8-php8.1](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.1/cli/Dockerfile) | [4.8.8-php8.1-dev, 4.8-php8.1-dev](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.1/cli/Dockerfile) | [4.8.8-php8.1-alpine, 4.8-php8.1-alpine](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.1/alpine/Dockerfile) |
| PHP 8.0 | [4.8.8-php8.0, 4.8-php8.0<br />4.8, latest](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.0/cli/Dockerfile) | [4.8.8-php8.0-dev, 4.8-php8.0-dev<br />4.8-dev, latest-dev](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.0/cli/Dockerfile) | [4.8.8-php8.0-alpine, 4.8-php8.0-alpine<br />4.8-alpine, latest-alpine](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php8.0/alpine/Dockerfile) |
| PHP 7.4 | [4.8.8-php7.4, 4.8-php7.4](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.4/cli/Dockerfile) | [4.8.8-php7.4-dev, 4.8-php7.4-dev](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.4/cli/Dockerfile) | [4.8.8-php7.4-alpine, 4.8-php7.4-alpine](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.4/alpine/Dockerfile) |
| PHP 7.3 | [4.8.8-php7.3, 4.8-php7.3](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.3/cli/Dockerfile) | [4.8.8-php7.3-dev, 4.8-php7.3-dev](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.3/cli/Dockerfile) | [4.8.8-php7.3-alpine, 4.8-php7.3-alpine](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.3/alpine/Dockerfile) |
| PHP 7.2 | [4.8.8-php7.2, 4.8-php7.2](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.2/cli/Dockerfile) | [4.8.8-php7.2-dev, 4.8-php7.2-dev](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.2/cli/Dockerfile) | [4.8.8-php7.2-alpine, 4.8-php7.2-alpine](https://github.com/swoole/docker-swoole/blob/master/dockerfiles/4.8.8/php7.2/alpine/Dockerfile) |
...
./bin/generate-dockerfiles.php 4.8.8  # Generate dockerfiles to build images for Swoole 4.8.8.
```
...
docker build -t phpswoole/swoole:4.8.8-php8.0        -f dockerfiles/4.8.8/php8.0/cli/Dockerfile    .
docker build -t phpswoole/swoole:4.8.8-php8.0-alpine -f dockerfiles/4.8.8/php8.0/alpine/Dockerfile .
```
...
docker build --build-arg DEV_MODE=true -t phpswoole/swoole:4.8.8-php8.0-dev -f dockerfiles/4.8.8/php8.0/cli/Dockerfile  .
```

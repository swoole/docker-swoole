...
| PHP Versions | Default Images | Dev Images | ZTS Images | Alpine Images |
|-|-|-|-|-|
| PHP 8.4 | [6.1.8-php8.4][6.1-php8.4]<br />[6.1-php8.4]<br />[6.1][6.1-php8.4] | [6.1.8-php8.4-dev][6.1-php8.4]<br />[6.1-php8.4-dev][6.1-php8.4]<br />[6.1-dev][6.1-php8.4] | [6.1.8-php8.4-zts][6.1-php8.4-zts]<br />[6.1-php8.4-zts]<br />[6.1-zts][6.1-php8.4-zts] | [6.1.8-php8.4-alpine][6.1-php8.4-alpine]<br />[6.1-php8.4-alpine]<br />[6.1-alpine][6.1-php8.4-alpine] |
| PHP 8.3 | [6.1.8-php8.3][6.1-php8.3]<br />[6.1-php8.3] | [6.1.8-php8.3-dev][6.1-php8.3]<br />[6.1-php8.3-dev][6.1-php8.3] | [6.1.8-php8.3-zts][6.1-php8.3-zts]<br />[6.1-php8.3-zts] | [6.1.8-php8.3-alpine][6.1-php8.3-alpine]<br />[6.1-php8.3-alpine] |
| PHP 8.2 | [6.1.8-php8.2][6.1-php8.2]<br />[6.1-php8.2] | [6.1.8-php8.2-dev][6.1-php8.2]<br />[6.1-php8.2-dev][6.1-php8.2] | [6.1.8-php8.2-zts][6.1-php8.2-zts]<br />[6.1-php8.2-zts] | [6.1.8-php8.2-alpine][6.1-php8.2-alpine]<br />[6.1-php8.2-alpine] |
| PHP 8.1 | [6.1.8-php8.1][6.1-php8.1]<br />[6.1-php8.1] | [6.1.8-php8.1-dev][6.1-php8.1]<br />[6.1-php8.1-dev][6.1-php8.1] | [6.1.8-php8.1-zts][6.1-php8.1-zts]<br />[6.1-php8.1-zts] | [6.1.8-php8.1-alpine][6.1-php8.1-alpine]<br />[6.1-php8.1-alpine] |
...
[6.1-php8.4]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.4/cli/Dockerfile
[6.1-php8.4-zts]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.4/zts/Dockerfile
[6.1-php8.4-alpine]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.4/alpine/Dockerfile
[6.1-php8.3]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.3/cli/Dockerfile
[6.1-php8.3-zts]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.3/zts/Dockerfile
[6.1-php8.3-alpine]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.3/alpine/Dockerfile
[6.1-php8.2]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.2/cli/Dockerfile
[6.1-php8.2-zts]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.2/zts/Dockerfile
[6.1-php8.2-alpine]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.2/alpine/Dockerfile
[6.1-php8.1]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.1/cli/Dockerfile
[6.1-php8.1-zts]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.1/zts/Dockerfile
[6.1-php8.1-alpine]: https://github.com/swoole/docker-swoole/blob/6.1.8/dockerfiles/6.1.8/php8.1/alpine/Dockerfile
